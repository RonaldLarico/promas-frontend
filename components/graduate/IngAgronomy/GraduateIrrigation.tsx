...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/BROCHURE/RIEGO_FERTIRRIEGO.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/BROCHURE/RIEGO_FERTIRRIEGO.pdf';
    link.download = 'RIEGO_FERTIRRIEGO.pdf';
    link.click();
  };
...
export default GraduateIrrigation;
