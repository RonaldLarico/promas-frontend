...
const GraduateTechnicalIrrigation = () => {
              ...
              <div className="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 gap-2">
                <div className="w-full">
                  <Link
                    ...
                    href='https://wa.me/+51957033871?text=Hola,%20deseo%20más%20información%20sobre%20el%20diplomado%20de%20Sistema%20de%20Riego%20Tecnificado'
                    target="_blank">
...
export default GraduateTechnicalIrrigation;
