...
import { modulesAmbientaly } from "@/components/utils/courses/course";
              ...
              <div className="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 gap-2">
                <div className="w-full">
                  <Link
                    ...
                    href='https://wa.me/+51957033871?text=Hola,%20deseo%20más%20información%20sobre%20el%20diplomado%20de%20Estudio%20de%20Impacto%20Ambiental'
                    target="_blank">
            ...
            {isAccordionOpen1 && (
              <motion.div
                ...
                <div className="text-sm font-sans font-semibold">
                  <ul className="">
                  {modulesAmbientaly.map((item, index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0 }}
