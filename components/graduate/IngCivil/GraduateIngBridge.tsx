...
import { modulesIngBridge } from "@/components/utils/courses/course";
import { BiChevronDown, BiChevronUp } from "react-icons/bi";
import { FaRegFilePdf, FaWhatsapp } from "react-icons/fa6";
import Modal  from "@/components/share/Modal";
import Image from "next/image";

const GraduateIngBridge = () => {
...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/BROCHURE/INGENIERIA_PUENTES.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/BROCHURE/INGENIERIA_PUENTES.pdf';
    link.download = 'INGENIERIA_PUENTES.pdf';
    link.click();
  };
          ...
          <div className="sm:w-1/2 md:px-20 sm:px-5 lg:mt-6">
            ...
            <div className="mb-4">
              <p className="text-sm font-semibold text-gray-600">
                ...
                relacionados con proyectos viales.
              </p>
            </div>
              ...
              <div className="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 gap-2">
                <div className="w-full">
                  <Link
                    ...
                    href='https://wa.me/+51957033871?text=Hola,%20deseo%20más%20información%20sobre%20el%20diplomado%20de%20Ingeniería%20de%20Puentes'
                    target="_blank">
            ...
            {isAccordionOpen1 && (
              <motion.div
                ...
                <div className="text-sm font-sans font-semibold">
                  <ul className="">
                  {modulesIngBridge.map((item, index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0 }}
...
export default GraduateIngBridge;
