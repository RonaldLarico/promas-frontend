...
import { modulesWorksSupervision } from "@/components/utils/courses/course";
import { BiChevronDown, BiChevronUp } from "react-icons/bi";
import { FaRegFilePdf, FaWhatsapp } from "react-icons/fa6";
import Modal  from "@/components/share/Modal";
import Image from "next/image";

const GraduateWorksSupervision = () => {
...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/BROCHURE/RESIDENCIA_SUPERVISIÓN_OBRAS.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/BROCHURE/RESIDENCIA_SUPERVISIÓN_OBRAS.pdf';
    link.download = 'RESIDENCIA_SUPERVISIÓN_OBRAS.pdf';
    link.click();
  };

  return (
    <div id="ato" className="">
          ...
          <div className="sm:w-1/2 md:px-20 sm:px-5 lg:mt-6">
            ...
            <div className="mb-4">
              <p className="text-sm font-semibold text-gray-600">
                ...
                Profesionales del sector público y privado relacionados con proyectos de 
                obras civiles.
              </p>
            </div>
            <div className="grid lg:grid-cols-2 grid-cols-1 text-pink-500 text-sm mb-4">
              ...
              <Image
                ...
                width={20}
                height={20}/>
                <p className="font-bold ml-1">Inicio 03 de Marzo</p>
              </div>
              ...
              <div className="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 gap-2">
                <div className="w-full">
                  <Link
                    ...
                    href='https://wa.me/+51957033871?text=Hola,%20deseo%20más%20información%20sobre%20el%20diplomado%20de%20Residencia%20y%20Supervición%20de%20Obras'
                    target="_blank">
            ...
            {isAccordionOpen1 && (
              <motion.div
                ...
                <div className="text-sm font-sans font-semibold">
                  <ul className="">
                  {modulesWorksSupervision.map((item, index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0 }}
...
export default GraduateWorksSupervision;
